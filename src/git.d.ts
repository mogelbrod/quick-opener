...
// See https://github.com/microsoft/vscode/blob/main/extensions/git/README.md for usage instructions.
...
export interface CommitOptions {
   ...
   * undefined - execute the command specified in git.postCommitCommand after the commit operation
...
export interface API {
   ...
   * Make sure to pass `postCloneAction` 'none' if you want to have the uri where you can find
